...
public class BookingViewController {
    ...
    public String getBookingList(@RequestParam Integer memberId,
        ...
        bookings.forEach(booking -> {
            booking.setFormattedCheckInDate(bookingService.formatBookingDate(booking.getCheckInDate()));
            booking.setFormattedCheckOutDate(bookingService.formatBookingDate(booking.getCheckOutDate()));
            booking.setFormattedPayPrice(bookingService.formatPayPrice(booking.getPayPrice()));
        });
